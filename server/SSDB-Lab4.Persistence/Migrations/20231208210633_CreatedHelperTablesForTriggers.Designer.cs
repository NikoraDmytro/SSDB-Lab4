...
namespace SSDB_Lab4.Persistence.Migrations
{
    ...
    [Migration("20231208210633_CreatedHelperTablesForTriggers")]
    partial class CreatedHelperTablesForTriggers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSDB_Lab4.Domain.entities.CompetitionCopy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("competition_copy_id");
                    ...
                    b.ToTable("competition_copies", (string)null);
                });
            ...
            modelBuilder.Entity("SSDB_Lab4.Domain.entities.CompetitorLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("competitor_logs", (string)null);
                });
            ...
            modelBuilder.Entity("SSDB_Lab4.Domain.entities.FailedInsertCompetitorLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("failed_insert_competitor_logs", (string)null);
                });
            ...
            modelBuilder.Entity("SSDB_Lab4.Domain.entities.CompetitorLog", b =>
                {
                    b.HasOne("SSDB_Lab4.Domain.entities.Competitor", "Competitor")
                        .WithMany()
