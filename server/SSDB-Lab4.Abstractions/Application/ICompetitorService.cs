...
{
    Task<IEnumerable<CompetitorDto>> GetCompetitorsAsync(int competitionId);
    ...
    Task UpdateCompetitorAsync(int id, UpdateCompetitorLapDto updateCompetitorLapDto);
    Task UpdateCompetitorAsync(int id, UpdateCompetitorWeightDto updateCompetitorWeightDto);
}